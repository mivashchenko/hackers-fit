...
const createPrompt = (
    ...
    return `Сформируй распределение калорий для клиента с суточным калоражем: ${bmr}. 
            ...
            Клиент: женщина ${age} лет, вес ${weight}кг, рост ${height}см. PAL ${pal}.
            Диагнозы: инсулинорезистентность, увеличенная печень, гастрит
            Количество приемов пищи: 3 основных и 2 перекуса.

            Результат выдай без пояснений, списком через запятую, Цифры округляй`
}
